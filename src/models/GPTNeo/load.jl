...
using ..TransformerLayers: CompositeEmbedding, SelfAttention, MultiheadQKVAttenOp, @fluxshow, @fluxlayershow, LocalCausalMultiheadQKVDotAttenOp, CausalMultiheadQKVDotAttenOp
...
(model::HGFGPTNeoForCausalLM)(nt::NamedTuple) = model.cls(model.model(nt))

const HGFGPTNeoPreTrainedModel = HGFPreTrained{:gpt_neo}
